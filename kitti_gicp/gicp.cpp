...
{	
	...
	string source_file = "/home/chenxin/Desktop/kitti_pcl_test/kitti_raw_05/" + to_string(idx) + ".pcd";
	string target_file = "/home/chenxin/Desktop/kitti_pcl_test/kitti_raw_05/" + to_string(idx + 1) + ".pcd";
	...
	*/
	...
	if (gicp.hasConverged())//icp.hasConverged ()=1（true）输出变换矩阵的适合性评估
	{
		...
		Eigen::Matrix4f seq_transformation = gicp.getFinalTransformation() * seq_tf;
